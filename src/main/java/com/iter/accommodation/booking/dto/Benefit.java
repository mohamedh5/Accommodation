...
public class Benefit implements Serializable
{
    ...
    private final static long serialVersionUID = 256083521181571958L;
    ...
    public String toString() {
        ...
        sb.append(Benefit.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("kind");
        sb.append('=');
