...
public class SumCredits implements Serializable
{
    ...
    private final static long serialVersionUID = 4237172288270242875L;
    ...
    public String toString() {
        ...
        sb.append(SumCredits.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
